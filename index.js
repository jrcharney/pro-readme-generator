...
function writeToFile(fileName, data) {
    ...
    readme.setTitleHeader(data.reponame)
          ...
          .addSection("License",`![${data.license}](./assets/images/LICENSE.svg)`)
          .addSection("Installation",`<pre>${data.install_command}</pre>`)
          .addSection("Testing",`<pre>${data.test_command}</pre>`)
          .addSection("Usage",`<pre>${data.use_command}</pre>`)
